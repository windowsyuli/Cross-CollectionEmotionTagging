function [averpreA,averMRRA,averKLA,averpreB,averMRRB,averKLB,t] = Method1(File,part,l1,l2,l3,l4)
        ...
        while lamwa <= lamwae
            ...
            while lamwb <= lamwbe
                ...
                for j=1:cross
                    ...
                    FtrainA = ftmatrixA;
                    FtestA = ftmatrixA1(rand(1,1+floor(doc_numA/part):end),:);
                    
                    FatrainA = fatmatrixA;
                    FatestA = fatmatrixA1(rand(1,1+floor(doc_numA/part):end),:);
                    
                    XtrainB=doc_term_matrixB;
                    XtestB=doc_term_matrixB;  %data for testing
                    
                    ttrainB=TB;  % emotion distribution for training
                    ttestB=TB;    % emotion distribution for testing
